#
#  Be sure to run `pod spec lint GRTabBarController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  #s.description  = "Highly customizable tabBar and tabBarController for iOS"
  ...
  s.author             = { "ios_dev5" => "heyuzu2007@sina.com" }
  # Or just: s.author    = "ios_dev5"
  # s.authors            = { "ios_dev5" => "heyuzu2007@sina.com" }
  # s.social_media_url   = "http://twitter.com/ios_dev5"
